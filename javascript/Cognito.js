(function(win, CognitoUserPool) {
  ...
  function change(username, oldpassword, newpassword) {
  ...
  function forgot(username) {
    ...
    return new Promise(function(resolve, reject) {
      User.forgotPassword(function(err, result) {
        if (err) {
          reject(err);
          return;
        }
    ...
    return new Promise(function(resolve, reject) {
      User.authenticateUser(authenticationDetails, {
        onSuccess:  function (result) {
                    updateUserLogin(result.getIdToken().getJwtToken());
  ...
  function updateUserLogin(token){
